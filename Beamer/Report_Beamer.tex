...
\institute[Amirkabir University of Techonology]{
    ...
    Course: Advanced Engineering Mathematics\\[1cm] % Professor's Name
...
\begin{frame}{Types of Wavelets}
    \begin{itemize}
        ...
        {\small \textbf {Figure 1:}Different Wavelets.} % Caption text
...
\begin{frame}{Why Wavelet Help}
    \begin{itemize}
        ...
        \\[0.2cm] % Add vertical spacing between image and caption
        {\small \textbf {Figure 2:}Example Sparse Matrix} % Caption text
    \end{itemize}
\end{frame}
...
\begin{frame}{Solved Case}
    \begin{itemize}
        ...
        \\[0.2cm] % Add vertical spacing between image and caption
        {\small \textbf {Figure 3:}Case Study} % Caption text
    \end{itemize}
\end{frame}
...
\begin{frame}{Plots}
    ...
    \begin{columns}[T]
        ...
        {\scriptsize {Figure 6:}Detailed and Approximation} % Optional: Add caption
        \column{0.5\textwidth}
        \centering
        \includegraphics[width=\textwidth, height=0.6\textheight]{Tree graph.jpg} \\[0.2cm] % Replace with your image file
        {\scriptsize {Figure 7:}Tree Graph} % Optional: Add caption
